...
<div class="window-droptower" id="wdt-vipavaroza">
    <div class="window-droptower-close" id="window-droptower-close-xiii"></div>
    <div class="window-droptower-container-flex">
        <div class="window-droptower-content-1">
            ...
            <div class="wdt-contentFlex-1">
                ...
                comprado mais de 1 Mês de VIP Avaroza!
                ...
                <div class="wdt-purchase-interface">
                    <div class="wdt-purchase-mounthQuantity">
                        <div class="wdt-purchase-mountQuantity-subcontainer">
                            <select name="VIPAVAROZA" class="wdt-selection" id="wdt-selection-xiii"></select>
                    ...
                    <div class="wdt-purchase-totalInterface">
                        <label class="wdt-label-totalAmount" id="wdt-labelviewTotal-xiii">49,99 R$</label>
                    </div>
                </div>
            </form>
